...
###Feb
### Logan ctrl F: 19Feb
LRStartDate = "2015-02-19"          ##yyyy-mm-dd format
LREndDate = "2015-02-20"
LR_FB_BADateTime= "2015-02-19 16:45:00"  ##yyyy-mm-dd hh:mm:ss format, rounded to 0, 15, 30, or 45 minute mark
LR_TG_BADateTime = "2015-02-19 14:45:00"
LR_WaterLab_AADateTime = "2015-02-19 12:00:00"
LR_MainStreet_BADateTime = "2015-02-19 12:00:00"
LR_Mendon_AADateTime = "2015-02-19 11:30:00"

### Red Butte ctrl F: 18Feb 
RBStartDate = "2015-02-18"          ##yyyy-mm-dd format
RBEndDate = "2015-02-19"  
RB_KF_BADateTime = "2015-02-18 10:45:00"   ##yyyy-mm-dd hh:mm:ss format, rounded to 0, 15, 30, or 45 minute mark
RB_ARBR_AADateTime = "2015-02-18 14:00:00"
RB_RBG_BADateTime = "2015-02-18 13:15:00"
RB_CG_BADateTime = "2015-02-18 12:45:00"
RB_FD_AADateTime = "2015-02-18 12:00:00"

### Provo ctrl F: 20Feb
PRStartDate = "2015-02-20"          ##yyyy-mm-dd format 
PREndDate ="2015-02-21" 
PR_ST_BADateTime = "2015-02-20 09:15:00"  ##yyyy-mm-dd hh:mm:ss format, rounded to 0, 15, 30, or 45 minute mark
PR_BJ_AADateTime = "2015-02-20 10:00:00"  ## must be rounded to on the hour e.g. 14:00:00
PR_LM_BADateTime = "2015-02-20 11:00:00"  ## must be rounded to on the hour e.g. 14:00:00
PR_CH_AADateTime = "2015-02-20 12:00:00"  ## must be rounded to on the hour e.g. 14:00:00
...
Franklin19FebGrabSample <- data.frame(DateTime = EXWTempFranklin$time, 
                                    Site = "LR_FB_BA",
...
Franklin19FebGrabSample

TonyGrove19FebGrabSample <- data.frame(DateTime = EXWTempTonyGrove$time, 
                                    Site = "LR_TG_BA",
...
TonyGrove19FebGrabSample

WaterLab19FebGrabSample <- data.frame(DateTime = EXWTempWaterLab$time, 
                                    Site = "LR_WaterLab_AA",
...
WaterLab19FebGrabSample

MainSt19FebGrabSample <- data.frame(DateTime = EXWTempMainSt$time, 
...
MainSt19FebGrabSample

Mendon19FebGrabSample <- data.frame(DateTime = EXWTempMendon$time, 
                              Site = "LR_Mendon_AA",
...
Mendon19FebGrabSample

Logan19Feb<-rbind.fill(Franklin19FebGrabSample, TonyGrove19FebGrabSample, WaterLab19FebGrabSample, MainSt19FebGrabSample, Mendon19FebGrabSample )
...
##Knowlton Fork pH##
pHKnowlton<- GetValues(RBserver, siteCode="iutah:RB_KF_BA", variableCode="iutah:WaterTemp_EXO", startDate = RBStartDate, endDate = RBEndDate, qcID = "1" )
...
Knowlton18FebGrabSample <- data.frame(DateTime = EXWTempKnowlton$time, 
                                      Site = "RB_KF_BA",
...
Knowlton18FebGrabSample
# 
# ARBR18FebGrabSample <- data.frame(DateTime = EXWTempARBR$time, 
#                                   Site = "RB_ARBR_AA",
...
RBG18FebGrabSample <- data.frame(DateTime = EXWTempRBG$time, 
                                    Site = "RB_RBG_BA",
...
CGrove18FebGrabSample <- data.frame(DateTime = EXWTempCGrove$time, 
                                    Site = "RB_CG_BA",
...
CGrove18FebGrabSample

Foothill18FebGrabSample <- data.frame(DateTime = EXWTempFoothill$time, 
                                      Site = "RB_FD_AA",
...
Foothill18FebGrabSample

RedButte18Feb<- rbind.fill(Knowlton18FebGrabSample, # ARBR18FebGrabSample,
                           RBG18FebGrabSample, CGrove18FebGrabSample, Foothill18FebGrabSample)
...
Soapstone20FebGrabSample <- data.frame(DateTime = EXWTempST$time, 
                                       Site = "PR_ST_BA",
...
Soapstone20FebGrabSample



BelowJordanelle20FebGrabSample <- data.frame(DateTime = EXWTempBJ$time, 
                                             Site = "PR_BJ_AA",
...
BelowJordanelle20FebGrabSample

LowerMidway20FebGrabSample <- data.frame(DateTime = EXWTempLM$time, 
                                         Site = "PR_LM_BA",
                                         ...
                                         Gage = QLM$DataValue)
LowerMidway20FebGrabSample

Charleston20FebGrabSample <- data.frame(DateTime = EXWTempCH$time, 
                                        Site = "PR_CH_AA",
...
Charleston20FebGrabSample

Provo20Feb <-rbind.fill(Soapstone20FebGrabSample, BelowJordanelle20FebGrabSample, LowerMidway20FebGrabSample, Charleston20FebGrabSample)


##### All combine and write ####

GrabSamples19Feb <- rbind.fill(RedButte18Feb, Logan19Feb, Provo20Feb)

write.csv(GrabSamples19Feb, file = "GrabSamples2" )
