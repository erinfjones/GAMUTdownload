...
setwd("~/Box Sync/BYU/metagenomics/GAMUTAquaticstationdata")
...
###Summer 15
### Logan ctrl F: 17Aug
LRStartDate = "2015-08-17"          ##yyyy-mm-dd format
LREndDate = "2015-08-20"
LR_FB_BADateTime= "2015-08-19 13:30:00"  ##yyyy-mm-dd hh:mm:ss format, rounded to 0, 15, 30, or 45 minute mark
LR_TG_BADateTime = "2015-08-19 09:00:00"
LR_WaterLab_AADateTime = "2015-08-19 14:45:00"
LR_MainStreet_BADateTime = "2015-08-17 15:00:00"
LR_Mendon_AADateTime = "2015-08-17 09:45:00"
##Below third dam and Wood Camp no sensors installed

### Red Butte ctrl F: 20Jul
RBStartDate = "2015-05-12"          ##yyyy-mm-dd format
RBEndDate = "2015-05-13"  
RB_KF_BADateTime = "2015-05-12 12:45:00"   ##yyyy-mm-dd hh:mm:ss format, rounded to 0, 15, 30, or 45 minute mark
RB_ARBR_AADateTime = "2015-07-21 12:15:00"
RB_RBG_BADateTime = "2015-07-21 11:15:00"
RB_CG_BADateTime = "2015-07-21 10:15:00"
RB_FD_AADateTime = "2015-07-20 16:30:00"
RB_1300E_ADateTime = "2015-07-20 10:30:00"
##LDSward iutah:RB_1300E_A , Miller park 

### Provo ctrl F: 31Oct
PRStartDate = "2015-10-31"          ##yyyy-mm-dd format 
PREndDate ="2015-11-01" 
PR_ST_BADateTime = "2015-10-31 10:00:00"  ##yyyy-mm-dd hh:mm:ss format, rounded to 0, 15, 30, or 45 minute mark
PR_BJ_AADateTime = "2015-10-31 15:00:00"  ## must be rounded to on the hour e.g. 14:00:00
PR_LM_BADateTime = "2015-10-31 12:00:00"  ## must be rounded to on the hour e.g. 14:00:00
PR_CH_AADateTime = "2015-10-31 12:00:00"  ## must be rounded to on the hour e.g. 14:00:00
##Woodland 12:15, hailstone 13:15
...
Franklin17AugGrabSample <- data.frame(DateTime = EXWTempFranklin$time, 
                                    Site = "LR_FB_BA",
...
Franklin17AugGrabSample

TonyGrove17AugGrabSample <- data.frame(DateTime = EXWTempTonyGrove$time, 
                                    Site = "LR_TG_BA",
...
TonyGrove17AugGrabSample

WaterLab17AugGrabSample <- data.frame(DateTime = EXWTempWaterLab$time, 
                                    Site = "LR_WaterLab_AA",
...
WaterLab17AugGrabSample

MainSt17AugGrabSample <- data.frame(DateTime = EXWTempMainSt$time, 
...
MainSt17AugGrabSample

Mendon17AugGrabSample <- data.frame(DateTime = EXWTempMendon$time, 
                              Site = "LR_Mendon_AA",
...
Mendon17AugGrabSample

Logan17Aug<-rbind.fill(Franklin17AugGrabSample, TonyGrove17AugGrabSample, WaterLab17AugGrabSample, MainSt17AugGrabSample, Mendon17AugGrabSample )
...
Knowlton20JulGrabSample <- data.frame(DateTime = EXWTempKnowlton$time, 
                                      Site = "RB_KF_BA",
...
Knowlton20JulGrabSample

ARBR20JulGrabSample <- data.frame(DateTime = EXWTempARBR$time,
                                  Site = "RB_ARBR_AA",
...
RBG20JulGrabSample <- data.frame(DateTime = EXWTempRBG$time, 
                                    Site = "RB_RBG_BA",
...
CGrove20JulGrabSample <- data.frame(DateTime = EXWTempCGrove$time, 
                                    Site = "RB_CG_BA",
...
CGrove20JulGrabSample

Foothill20JulGrabSample <- data.frame(DateTime = EXWTempFoothill$time, 
                                      Site = "RB_FD_AA",
...
Foothill20JulGrabSample

RedButte20Jul<- rbind.fill(Knowlton20JulGrabSample,  ARBR20JulGrabSample,
                           RBG20JulGrabSample, CGrove20JulGrabSample, Foothill20JulGrabSample)
...
Soapstone31OctGrabSample <- data.frame(DateTime = EXWTempST$time, 
                                       Site = "PR_ST_BA",
...
Soapstone31OctGrabSample



BelowJordanelle31OctGrabSample <- data.frame(DateTime = EXWTempBJ$time, 
                                             Site = "PR_BJ_AA",
...
BelowJordanelle31OctGrabSample

LowerMidway31OctGrabSample <- data.frame(DateTime = EXWTempLM$time, 
                                         Site = "PR_LM_BA",
                                         ...
                                         Gage = QLM$DataValue)
LowerMidway31OctGrabSample

Charleston31OctGrabSample <- data.frame(DateTime = EXWTempCH$time, 
                                        Site = "PR_CH_AA",
...
Charleston31OctGrabSample

Provo31Oct <-rbind.fill(Soapstone31OctGrabSample, BelowJordanelle31OctGrabSample, LowerMidway31OctGrabSample, Charleston31OctGrabSample)


##### All combine and write ####

GrabSamples17Aug <- rbind.fill(RedButte20Jul, Logan17Aug, Provo31Oct)

write.csv(GrabSamples17Aug, file = "GrabSamples5" )
